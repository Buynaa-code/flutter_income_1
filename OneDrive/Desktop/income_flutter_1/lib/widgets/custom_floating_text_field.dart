...
class CustomFloatingTextField extends StatelessWidget {
  ...
  Widget get floatingTextFieldWidget => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.titleSmallBluegray500Medium,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.titleSmallBluegray500Medium,
        labelText: labelText ?? "",
        ...
        isDense: true,
        contentPadding:
            contentPadding ?? EdgeInsets.fromLTRB(16.h, 20.v, 16.h, 16.v),
        fillColor: fillColor,
        filled: filled,
